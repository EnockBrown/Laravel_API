...
@section('content')
            ...
            <div class="card">
                <div class="btn btn-secondary btn-lg btn-block">Dashboard</div>
                              ...
                              <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="navbar-brand" href="{{ url('/orders') }}">
                                        <button type="button" class="btn btn-outline-success">Orders</button>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="navbar-brand" href="{{ url('/products') }}">
                                        <button type="button" class="btn btn-outline-success">Products</button>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="navbar-brand" href="{{ url('/payments') }}">
                                        <button type="button" class="btn btn-outline-success">Payments</button>
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="navbar-brand" href="{{ url('/users') }}">
                                        <button type="button" class="btn btn-outline-success">Customers</button>
                                    </a>
                                </li>
